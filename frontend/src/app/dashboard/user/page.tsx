      ...
      <main className="flex-1 px-4 py-10 bg-[#F7F7F7]">
        <div className="max-w-6xl mx-auto flex gap-6">
          ...
          <aside className="hidden md:block w-64 shrink-0">
            <div className="bg-white rounded-xl shadow p-5 sticky top-6">
              ...
              <nav className="space-y-1 text-sm">
                <Link href="/dashboard/user" className="block px-3 py-2 rounded-md bg-[#1E3A5F] text-white">لوحة المستخدم</Link>
                <Link href="#" className="block px-3 py-2 rounded-md hover:bg-gray-50">حجوزاتي</Link>
                <Link href="#" className="block px-3 py-2 rounded-md hover:bg-gray-50">مفضلتي</Link>
                <Link href="#" className="block px-3 py-2 rounded-md hover:bg-gray-50">رسائلي</Link>
          ...
          <div className="flex-1">
            <h1 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] mb-6">لوحة التحكم — المستخدم</h1>

            {/* Quick summary */}
            <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-white rounded-xl shadow p-5">
                <div className="text-sm text-gray-500">الحجوزات النشطة</div>
                <div className="text-2xl font-bold mt-2">2</div>
              </div>
              <div className="bg-white rounded-xl shadow p-5">
                <div className="text-sm text-gray-500">العقارات المفضلة</div>
                <div className="text-2xl font-bold mt-2">5</div>
              </div>
              <div className="bg-white rounded-xl shadow p-5">
                <div className="text-sm text-gray-500">الرسائل الجديدة</div>
            ...
            <section className="bg-white rounded-xl shadow p-6 mb-8">
              <h2 className="text-lg font-semibold mb-4">أحدث الحجوزات</h2>
              <ul className="space-y-3 text-sm">
                <li className="flex justify-between border-b pb-3">
                  <span>شقة مفروشة — فاس</span>
                  <span className="text-gray-500">من 20 إلى 22 مارس</span>
                </li>
                <li className="flex justify-between">
                  <span>استوديو — الرباط</span>
                  <span className="text-gray-500">من 3 إلى 5 أبريل</span>
                </li>
              </ul>
            </section>
            ...
            <section className="bg-white rounded-xl shadow p-6">
              <h2 className="text-lg font-semibold mb-4">حسابي</h2>
              <div className="flex flex-wrap gap-3">
                <button className="px-4 py-2 border rounded-md">تعديل المعلومات الشخصية</button>
                <button className="px-4 py-2 border rounded-md">تغيير كلمة المرور</button>
